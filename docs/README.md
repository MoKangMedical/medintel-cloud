# medintel-cloud API文档

## 概述

本文档描述了medintel-cloud项目的API接口规范和使用方法。
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/var/log/medintel-cloud/app.log'),
...
- 项目主页: https://github.com/MoKangMedical/medintel-cloud
